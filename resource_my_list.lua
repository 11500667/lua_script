...
local res = db:query("SELECT SQL_NO_CACHE id FROM t_resource_my_info_sphinxse WHERE query=\'"..keyword..structure_scheme.."filter=b_delete,0;filter=res_type,"..res_type..";"..str_rtype..sort_filed..bType_str..person_str..str_group.."maxmatches="..str_maxmatches..";offset="..offset..";limit="..limit.."\';SHOW ENGINE SPHINX  STATUS;")
...
for i=1,#res do
    ...
    if tostring(resource_value_null[2]) ~= "userdata: NULL" then
		...
		--end
          ...
          local structure_id = resource_value[26]
          local curr_path = ""
