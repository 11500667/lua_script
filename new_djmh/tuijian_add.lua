...
-- 申健 2015-08-22 将推荐数据维护到mysql数据库中 
...
local objIdInt, objIdChar = recommendModel: getObjIdInt(paramTable["obj_type"], info_id);
paramTable["obj_id_int"]  = objIdInt;
paramTable["obj_id_char"] = objIdChar;
paramTable["obj_info_id"] = info_id;
paramTable["stage_id"]    = stage_id;
paramTable["subject_id"]  = subject_id;
paramTable["person_id"]   = person_id;
paramTable["org_id"]      = bureau_id;
paramTable["sort_ts"]     = ts;
paramTable["b_top"]       = 0;
recommendModel: saveRecommend(paramTable);
-- 申健 2015-08-22 将推荐数据维护到mysql数据库中 申健 2015-08-22 
