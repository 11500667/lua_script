...
local ts =  myts.getTs();
local topTsStr = "9" .. string.sub(ts,2,#ts);
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id, info_id, topTsStr);
ngx.log(ngx.ERR, "\n[sj_log] -> [recommend] -> \nkey :[", "tuijian_"..sys_type.."_"..bureau_id, "], \ninfo_id : [", info_id, "], \ntopTsStr : [", topTsStr, "]\n");
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id, info_id, topTsStr);
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..subject_id,info_id,topTsStr);

ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..person_id, info_id, topTsStr);
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..person_id, info_id, topTsStr)
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..subject_id.."_"..person_id, info_id, topTsStr)
...
paramTable["sort_ts"]     = topTS;
paramTable["b_top"]       = 1; -- 0未置顶， 1已置顶
