...
local tuijian_key = ""
if stage_id == "-1" then
	tuijian_key = "tuijian_bk_"..bureau_id
else
	if subject_id == "-1" then
		tuijian_key = "tuijian_bk_"..bureau_id.."_"..stage_id
	else
		tuijian_key = "tuijian_bk_"..bureau_id.."_"..stage_id.."_"..subject_id
	end
end

local tuijian_bk_ts = redis_db:get("tuijian_bk_ts_"..bureau_id)
--local tuijian_bk_generate_ts = redis_db:get(tuijian_key.."_ts")
local tuijian_bk_generate_ts = redis_db:get(tuijian_key.."_"..pageSize.."_"..pageNumber.."_ts")

if tuijian_bk_ts == ngx.null then
	local uuid =  require "resty.uuid";
	tuijian_bk_ts = uuid.new();	
	redis_db:set("tuijian_bk_ts_"..bureau_id,tuijian_bk_ts)		
end

if tuijian_bk_generate_ts ~= tuijian_bk_ts or tuijian_bk_generate_ts == ngx.null then		
	
	--redis_db:set(tuijian_key.."_ts",tuijian_bk_ts)
	redis_db:set(tuijian_key.."_"..pageSize.."_"..pageNumber.."_ts",tuijian_bk_ts)
