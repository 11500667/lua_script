...
local res_new_tab = {}
if res_type == "1" then
	local res_sql = mysql_db:query("SELECT SQL_NO_CACHE id FROM t_resource_info_sphinxse WHERE query='"..group_str..stage_str.."filter=res_type,1,13;filter=release_status,1,3;groupby=attr:resource_id_int;groupsort=ts desc;limit="..show_size.."';")
