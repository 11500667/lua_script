...
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id, info_id)
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id, info_id)
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..subject_id, info_id)

--再记一遍人员
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id.."_"..person_id, info_id)
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..person_id, info_id)
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..subject_id.."_"..person_id, info_id)
...
-- 申健 2015-08-24 取消推荐数据时维护mysql中的数据
...
paramTable["org_id"]      = bureau_id;
recommendModel: delRecommend(paramTable);
-- 申健 2015-08-24 取消推荐数据时维护mysql中的数据
