...
local querysql = "select edu_type From t_base_organization where org_id=(select org_id from t_base_person where person_id='"..person_id.."')"
...
if query_res[1] == nil then
	...
	returnjson.edu_type = query_res[1]["edu_type"]
end
