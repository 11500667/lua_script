...
ngx.log(ngx.ERR, "**********东师理想微课大赛*****新增学校开始**********");	

local inssql = "insert into t_dswk_organization (ORG_NAME, CREATE_TIME, DISTRICT_ID, CITY_ID, PROVINCE_ID,b_use) values ('"..org_name.."', now(), '"..district_id.."', '"..city_id.."', '"..province_id.."',1);"
...
ngx.log(ngx.ERR, "**********东师理想微课大赛*****新增学校结束**********");	
