...
local countsql = "select count(*) as count from t_dswk_comment where b_use=1 and pid="..pid
...
local querysql= "select id,pid,create_time,content,person_id,b_use from t_dswk_comment where b_use=1 and pid = "..pid.." order by id desc limit "..offset..","..limit.."; "
