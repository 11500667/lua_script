...
local res, err, errno, sqlstate = db:query("SELECT class_id,class_name FROM t_base_class where b_use='1' and bureau_id = "..title..";")
ngx.log(ngx.ERR,"SELECT class_id,class_name FROM t_base_class where b_use='1' and bureau_id = "..title..";")
if not res then
...
if res == nil then
  ...
  for i=1,#res do
    ...
    registered_res.class_id = res[i]["class_id"]
    registered_res.class_name = res[i]["class_name"]
