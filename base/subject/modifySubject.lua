...
if product_count > 0 then
  ...
  result["info"] = "该学科已有产品，不能修改该学科！"
	...
	if count > 0 then
	  result["success"] = false
	  result["info"] = "该学科已有版本，不能修改该学科！"
	else
		local update_sql="update t_dm_subject set subject_name ='"..subject_name.."' where subject_id="..subject_id
