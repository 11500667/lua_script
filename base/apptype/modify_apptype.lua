...
local up_apptype = "UPDATE T_BASE_APPTYPE SET APP_TYPE_NAME = '"..app_type_name.."' WHERE APP_PRIME_ID = "..app_type_id.." AND SCHEME_ID =" ..scheme_id;
...
--local scheme_id_info = cache:hmget("t_base_apptype_"..app_type_id,"scheme_id")
--local  scheme_id = scheme_id_info[1];
-- 查询已经添加的媒体类型
