...
local apptype = tostring(cache:get("ht_apptype_scheme_"..scheme_id));
...
ngx.log(ngx.ERR,"返回的json==".."{\"success\":true,\"table_List\":"..apptype.."}")
ngx.say("{\"success\":true,\"table_List\":"..apptype.."}")
