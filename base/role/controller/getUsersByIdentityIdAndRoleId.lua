...
if identity_id==6 then
	--查询学生表
	--query_person_sql="select distinct t2.student_id as person_id,t2.stu_num as person_num,t2.student_name as person_name,t4.org_id,t4.org_name as person_name from T_SYS_PERSON_ROLE t1  join t_base_student t2 on t1.person_id=t2.student_id join t_base_class t3 on t2.class_id =t3.class_id join t_base_organization t4 on t3.org_id=t4.org_id "..query_condition.." LIMIT "..offset..","..limit; 	
	query_person_sql="select distinct t2.student_id as person_id,t2.stu_num as person_num,t2.student_name as person_name,t4.org_id,t4.org_name as person_name from  t_base_student t2  join t_base_class t3 on t2.class_id =t3.class_id join t_base_organization t4 on t3.org_id=t4.org_id "..query_condition.." LIMIT "..offset..","..limit; 	
	...
	--query_person_sql="select distinct t2.person_id,t2.person_name,t2.person_num,t2.org_id,t3.org_name from T_SYS_PERSON_ROLE t1  join t_base_person t2 on t1.person_id=t2.person_id left join t_base_organization t3 on t2.org_id=t3.org_id  "..query_condition.." LIMIT "..offset..","..limit; 	
	query_person_sql="select distinct t2.person_id,t2.person_name,t2.person_num,t2.org_id,t3.org_name from  t_base_person t2 left join t_base_organization t3 on t2.org_id=t3.org_id  "..query_condition.." LIMIT "..offset..","..limit; 	
