...
local sql = "SELECT T1.LOGIN_NAME, T2.PERSON_NAME, T2.PERSON_ID, PROVINCE.PROVINCENAME, T2.PROVINCE_ID, "..
			...
			"INNER JOIN T_SYS_LOGINPERSON T1 ON T1.PERSON_ID=T2.PERSON_ID AND T1.IDENTITY_ID=5 "..
			...
			"WHERE T2.B_USE=0 LIMIT "..offset..", "..limit..";" .. 
			"SELECT COUNT(1) AS RESULT_COUNT FROM T_BASE_PERSON WHERE B_USE=0;";
