...
-- 根据人员id查询对应的区id
local old_school_id = cache:hget("person_"..person_id.."_5","xiao");
-- 查询校管理员的人员id
local  sel_new_person_id = "SELECT PERSON_ID FROM t_base_person WHERE bureau_id ="..old_school_id.." and identity_id =4";
