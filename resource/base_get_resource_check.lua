...
--if app_type_id ~= "0" then 
	--next_sql = next_sql .. " AND APP_TYPE_ID = " .. app_type_id
--end  

if check_status ~= "4" then 
	next_sql = next_sql .. " AND CHECK_STATUS = ".. check_status .." ORDER BY create_time DESC limit " ..offset.." ," .. pageSize*pageNumber;
else
	next_sql = next_sql .. " AND CHECK_STATUS !=0 ORDER BY create_time DESC limit  " ..offset.." ," .. pageSize*pageNumber;
end 
