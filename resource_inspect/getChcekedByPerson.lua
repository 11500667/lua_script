...
--拼接sql语句
local sql_check = "SELECT t1.check_id,t2.check_name,t1.school_id FROM t_resource_check_person_subject AS t1 INNER JOIN t_resource_check_info as t2 ON t1.check_id = t2.check_id WHERE b_use = 1 and t2.status_id = 1  and person_id = "..person_id.." AND identity_id = "..identity_id.." GROUP BY t1.check_id";

ngx.log(ngx.ERR,"==========="..sql_check.."==================")
...
for i=1,#result_check do
   ...
   tab.school_id = result_check[i]["school_id"];
   person_check[i] = tab;
end
