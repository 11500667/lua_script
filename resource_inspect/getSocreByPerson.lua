...
--拼接sql语句
local sql_check = "SELECT  person_socre,person_comments from t_resource_check_person_score WHERE person_id  ="..person_id.." and check_id = "..check_id.." AND subject_id = "..subject_id.." and identity_id = "..identity_id;
...
resultJson.person_socre =result_check[1]["person_socre"];
resultJson.person_comments =result_check[1]["person_comments"];

else
resultJson.person_socre ="";
resultJson.person_comments ="";
end
