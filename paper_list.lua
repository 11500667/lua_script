...
ngx.log(ngx.ERR,"&&&&&&&&&&&".."SELECT SQL_NO_CACHE id FROM t_sjk_paper_info_sphinxse WHERE query=\'"..keyword..structure_scheme..str_ptype..str_paper_app_type.."filter=b_delete,0;select=("..str_group..") as match_qq;filter= match_qq, 1;"..sort_filed.."groupby=attr:structure_id;groupby=attr:paper_id_char;maxmatches="..str_maxmatches..";offset="..offset..";limit="..limit.."\';SHOW ENGINE SPHINX  STATUS;")
--local res = db:query("SELECT SQL_NO_CACHE id FROM t_sjk_paper_info_sphinxse WHERE query=\'"..keyword..structure_scheme..str_ptype.."filter=b_delete,0;select=("..str_group..") as match_qq;filter= match_qq, 1;"..sort_filed.."groupby=attr:structure_id;groupby=attr:paper_id_char;maxmatches="..str_maxmatches..";offset="..offset..";limit="..limit.."\';SHOW ENGINE SPHINX  STATUS;")
