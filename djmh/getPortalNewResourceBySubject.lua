...
--拼学段条件
local stage_str = "filter=stage_id,"..stage_id..";"
--拼科目条件
local subject_str = ""
...
--获取资源的最新资源
local res_new_tab = {}
local res_sql = mysql_db:query("SELECT SQL_NO_CACHE id FROM t_resource_info_sphinxse WHERE query='"..group_str..stage_str..subject_str.."filter=res_type,1;filter=release_status,1,3;groupby=attr:resource_id_int;groupsort=ts desc;limit="..show_size.."';")
ngx.log(ngx.ERR,"#########".."SELECT SQL_NO_CACHE id FROM t_resource_info_sphinxse WHERE query='"..group_str..stage_str..subject_str.."filter=res_type,1;filter=release_status,1,3;groupby=attr:resource_id_int;groupsort=ts desc;limit="..show_size.."';".."###########")
for i=1,#res_sql do    
