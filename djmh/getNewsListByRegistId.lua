...
local str_maxmatches = "1000"

--拼注册号条件
local str_registid = "filter=regist_id,"..regist_id..";"
--拼栏目条件
local str_column = ""
if column_id ~= "-1" then
	str_column = "filter=column_id,"..column_id..";"
end


local res = mysql_db:query("SELECT SQL_NO_CACHE id FROM t_news_info_sphinxse WHERE query='filter=b_delete,0;"..str_registid..str_column.."sort=attr_desc:ts;maxmatches="..str_maxmatches..";offset="..offset..";limit="..limit.."';SHOW ENGINE SPHINX  STATUS;")
