...
local res = db:query("SELECT SQL_NO_CACHE id FROM t_resource_info_sphinxse WHERE query=\'"..keyword..area_str..mtype_str..stage_str..subject_str..person_str.."filter=release_status,1,3;filter=res_type,1;sort=attr_desc:ts;maxmatches="..str_maxmatches..";offset="..offset..";limit="..limit..";"..mode.."\';SHOW ENGINE SPHINX  STATUS;")
...
for i=1,#res do
	...
	local res_info = cache:hmget("resource_"..res_info_id,"resource_id_int","resource_title","resource_type_name","resource_format","resource_page","resource_size","create_time","down_count","file_id","thumb_id","width","height","for_urlencoder_url","for_iso_url","parent_structure_name","preview_status","app_type_id","scheme_id_int","structure_id","subject_id","person_id","resource_type")
	...
	res_info_tab["person_id"] = res_info[21]
	res_info_tab["resource_type"] = res_info[22]	
