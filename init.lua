package.path = package.path .. ";/usr/local/lua_script/?.lua;/usr/local/lua_script_yx/?.lua;";
...
--mysql全局变量
v_mysql_ip="127.0.0.1"
v_mysql_port="22066"
v_mysql_database="dsideal_db"
v_mysql_user="root"
v_mysql_password="DsideaL147258369"
...
-- 组织机构共享设置
v_share_range = {
    { range_id = 0, name = "全国",   display = true, redis_key = "all"}, 
    { range_id = 1, name = "本省",   display = true, redis_key = "sheng"}, 
    { range_id = 2, name = "本市",   display = true, redis_key = "shi"}, 
    { range_id = 3, name = "本区",   display = true , redis_key = "qu"}, 
    { range_id = 4, name = "本校",   display = true , redis_key = "xiao"}, 
...
v_query_range = {
    ...
    { name = "本省",     display = true , query_key=6, redis_key = "sheng"}, 
