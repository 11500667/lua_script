--[[
备课中心根据personID获取发布到大学区和协作体的试卷[mysql版]
@Author  chenxg
@Date    2015-06-05
--]]
...
for i=1,#res do
	...
	local resource_value = ssdb_db:multi_hget("resource_"..paper_value[10],"preview_status","for_iso_url","for_urlencoder_url","file_id","resource_page","structure_id","scheme_id_int")
