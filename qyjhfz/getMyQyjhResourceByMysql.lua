--[[
备课中心根据personID获取发布到大学区和协作体的资源[mysql版]
@Author  chenxg
@Date    2015-06-05
--]]
...
local res = db:query("SELECT SQL_NO_CACHE id FROM t_base_publish_resource_sphinxse WHERE query='"..keyword..rtype_str..apptype_str..workroom_str..structure_scheme..delete_str..objtype_str..person_str..sort_filed.."groupby=attr:obj_info_id;maxmatches="..str_maxmatches..";offset="..offset..";limit="..limit.."\';SHOW ENGINE SPHINX  STATUS;")
...
for i=1,#res do
	...
	--ngx.log(ngx.ERR,"cxg_log ========>"..#resource_info.."<=============")
    ...
    local curr_path = ""
    local structures = cache:zrange("structure_code_"..resource_value[14],0,-1)
	...
	local  app_typeids =myPrime.dec_prime(resource_value[23]);
	...
	resource_info["app_type_id"] = resource_value[22]
	--*****
	]]
	local xzt_name=""
	local hd_name=""
