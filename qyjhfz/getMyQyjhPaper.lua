...
local res = db:query("SELECT SQL_NO_CACHE id FROM t_base_publish_paper_sphinxse WHERE query='"..keyword..workroom_str..structure_scheme..delete_str..person_str..sort_filed.."groupby=attr:obj_info_id;maxmatches="..str_maxmatches..";offset="..offset..";limit="..limit.."\';SHOW ENGINE SPHINX  STATUS;")
...
for i=1,#res do
	...
	resource_info["preview_status"] =resource_value[1]
	resource_info["for_iso_url"] =resource_value[2]
	resource_info["for_urlencoder_url"] =resource_value[3]
	resource_info["file_id"] =resource_value[4]
	resource_info["page"] =resource_value[5]
	resource_info["structure_id_int"] =resource_value[6]
	resource_info["scheme_id_int"] =resource_value[7]
	--*****
	local xzt_name=""
	local hd_name=""
