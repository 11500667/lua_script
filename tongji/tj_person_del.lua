...
local mycount = ssdb_db:hget("tj_person_"..subject_id.."_"..s_type.."_"..r_type.."_"..person_id,a_type_name)[1]
if #mycount >0 then
	if tonumber(mycount)>0 then
		ssdb_db:hdecr("tj_person_"..subject_id.."_"..s_type.."_"..r_type.."_"..person_id,a_type_name,count)
	end
end
mycount = ssdb_db:hget("tj_person_"..subject_id.."_"..s_type.."_"..person_id,a_type_name)[1]
if #mycount >0 then
	if tonumber(mycount)>0 then
		ssdb_db:hdecr("tj_person_"..subject_id.."_"..s_type.."_"..person_id,a_type_name,count)
	end
end
