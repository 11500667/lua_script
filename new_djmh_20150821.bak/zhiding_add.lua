...
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id,info_id,"9"..string.sub(ts,2,#ts))
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id,info_id,"9"..string.sub(ts,2,#ts))
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..subject_id,info_id,"9"..string.sub(ts,2,#ts))

ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..person_id,info_id,"9"..string.sub(ts,2,#ts))
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..person_id,info_id,"9"..string.sub(ts,2,#ts))
ssdb_db:zset("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..subject_id.."_"..person_id,info_id,"9"..string.sub(ts,2,#ts))
