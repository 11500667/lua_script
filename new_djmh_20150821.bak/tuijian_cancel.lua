...
--再记一遍人员
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id.."_"..person_id,info_id,ts)
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..person_id,info_id,ts)
ssdb_db:zdel("tuijian_"..sys_type.."_"..bureau_id.."_"..stage_id.."_"..subject_id.."_"..person_id,info_id,ts)
